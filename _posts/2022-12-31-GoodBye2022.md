...
<style>
    html{
        -webkit-filter: red(100%);
        -moz-filter: red(100%);
        -ms-filter: red(100%);
        -o-filter: red(100%);
        filter: red(100%);
        -webkit-filter: rgb(133, 0, 0);
        filter: rgb(133, 0, 0);
        -webkit-filter: progid:dximagetransform.microsoft.basicimage(red=1);
        filter: progid:dximagetransform.microsoft.basicimage(red=1);
    }
</style>
